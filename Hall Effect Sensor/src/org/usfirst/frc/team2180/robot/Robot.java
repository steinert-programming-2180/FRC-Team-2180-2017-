...
public class Robot extends IterativeRobot {
	public CANTalon left = new CANTalon (0);
	public CANTalon right = new CANTalon (1);
	public Joystick Tankleft = new Joystick (0);
	public Joystick Tankright = new Joystick (1);
	public Counter normalCounter = new Counter (0);
	public int count = normalCounter.get();
